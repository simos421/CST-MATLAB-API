...
exportpath = '...\cst api\NameofyourFile'; %NameofyourFile should be the same with the name of the file of line 93 bellow
...
for monitorindex = 0.5:0.5:4 
exportpath = strcat('...\cst api\farff',num2str(monitorindex),'.txt');
CstExportFarfieldSource(mws, exportpath, monitorindex)
end
